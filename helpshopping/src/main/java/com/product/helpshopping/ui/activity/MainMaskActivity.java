...
public class MainMaskActivity extends BaseActivity implements IInit, View.OnClickListener {
    private static final String TAG = MainMaskActivity.class.getSimpleName();
