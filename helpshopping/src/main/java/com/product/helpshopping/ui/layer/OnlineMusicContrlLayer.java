...
import com.product.helpshopping.thridpart.other.Douban;
import com.product.helpshopping.ui.base.BaseActivity;
import com.product.helpshopping.ui.beans.PlayBean;
import com.product.helpshopping.ui.service.OnlinePlayerService;
...
public class OnlineMusicContrlLayer extends FrameLayout implements View.OnClickListener {
    ...
    public void setPlayStatus(OnlineMusicContrlLayer.Status status) {
        ...
        getContext().startService(CommonUtils.getMaskIntent(
