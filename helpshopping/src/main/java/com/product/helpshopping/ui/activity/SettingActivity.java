...
import com.product.helpshopping.ui.layer.RawMusicContrlLayer;
...
public class SettingActivity extends BaseTitleActivity implements IInit, View.OnClickListener {
    ...
    protected void onDestroy() {
        ...
        // 关闭音乐播放服务
        // stopService(CommonUtils.getMaskIntent(this, null, LocalPlayerService.class));
    }
    ...
    public void initViews() {
        ...
        String key = CommonUtils.getMusicItemKey(this);
