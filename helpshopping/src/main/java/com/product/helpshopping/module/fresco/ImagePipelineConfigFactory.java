...
import com.product.helpshopping.module.ConfigConstants;
...
public class ImagePipelineConfigFactory {
    private static final String IMAGE_PIPELINE_CACHE_DIR = ImagePipelineConfigFactory.class.getSimpleName();
